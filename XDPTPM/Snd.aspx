<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Snd.aspx.cs" Inherits="XDPTPM.Snd" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <input id="btnClick" type="button" value="Send-Me" onserverclick="Unnamed_ServerClick" runat="server"/>
        </div>
    </form>
</body>
</html>
